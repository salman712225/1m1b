...
# ==================================================
st.set_page_config(
    page_title="AquaForecast X | AI Water Intelligence",
    page_icon="💧",
    layout="wide"
)
...
@st.cache_data
def load_data():
    return pd.read_csv("aquaforecast_ai_output.csv")
...
if st.button("Generate PDF"):
    file = f"AquaForecast_Summary_{country}.pdf"
    c = canvas.Canvas(file, pagesize=A4)
    text = c.beginText(40, 800)
    text.textLine("AquaForecast X – Executive Summary")
